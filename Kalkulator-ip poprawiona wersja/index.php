    ...
    <div class="formularz" id="formularz">
            <div class="formularz-input">
                <form action="./" method="post">
                    ...
                    <div class="przyciski">
                        <button class="myButton"> Adres sieciowy </button>
                         <button type="submit" class="myButton"> Adres Rozgłoszeniowy</button> 
                          <button type="submit" class="myButton"> Ilość hostów </button></br>
                        <button type="submit" class="myButton"> Ilość podsieci </button>
                         <button type="submit" class="myButton"> Host min/max </button>
                          <button type="submit" class="myButton"> Klasa sieci </button></br>

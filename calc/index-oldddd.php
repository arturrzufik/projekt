    ...
    <div class="formularz" id="formularz">
            <div class="formularz-input">
                <form action="./" method="post">
                    ...
                    Podaj maskę: <input class="css-input" name="maska" type='number' min="8" max="32"><br /><br /><br /><br />
                    <div class="przyciski">
                        <div id="inputPreview">
                            <br><br>
                            <input name="cssCheckbox" id="demo_opt_1" type="checkbox" class="css-checkbox" onclick="myFunction()">
                            <label for="demo_opt_1">Adres sieciowy</label>
                            <input name="cssCheckbox" id="demo_opt_2" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_2">Adres Rozgłoszeniowy</label>
                            <input name="cssCheckbox" id="demo_opt_3" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_3">Ilość hostów</label>
                            <input name="cssCheckbox" id="demo_opt_4" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_4">Ilość hostów</label>
                            <input name="cssCheckbox" id="demo_opt_5" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_5">Ilość podsieci</label>
                            <input name="cssCheckbox" id="demo_opt_6" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_6">Host min/max</label>
                            <input name="cssCheckbox" id="demo_opt_7" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_7">Klasa sieci</label>
                            <input name="cssCheckbox" id="demo_opt_8" type="checkbox" class="css-checkbox">
                            <label for="demo_opt_8">Oblicz wszystko</label>

                        </div>
                            <br><br><button type="submit" class="myButton-wszystko" id= "myButton-wszystko" onclick="myFunction()"> OBLICZ </button>
                    </div>
                </form>
...
#Broadcast
    ...
    <div id="hidden">
    <p><?php $adres_binarnie ?></p>
    </div>

    <script>
        function myFunction() {
            var checkBox = document.getElementById("demo_opt_1");
